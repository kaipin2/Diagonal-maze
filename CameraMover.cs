...
public class CameraMover : MonoBehaviour
{
    ...
    private void CameraPositionKeyControl()
    {
        ...
        if (Input.GetKey(KeyCode.C)) { campos += _camTransform.right * Time.deltaTime * _positionStep; }
        if (Input.GetKey(KeyCode.Z)) { campos -= _camTransform.right * Time.deltaTime * _positionStep; }
        if (Input.GetKey(KeyCode.S)) { campos += _camTransform.up * Time.deltaTime * _positionStep; }
        if (Input.GetKey(KeyCode.X)) { campos -= _camTransform.up * Time.deltaTime * _positionStep; }
        if (Input.GetKey(KeyCode.Q)) { campos += _camTransform.forward * Time.deltaTime * _positionStep; }
        if (Input.GetKey(KeyCode.E)) { campos -= _camTransform.forward * Time.deltaTime * _positionStep; }
